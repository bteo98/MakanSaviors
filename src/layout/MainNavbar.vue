                      ...
                      <ul class="dropdown-menu dropdown-with-icons">
                        ...
                        <li>
                          <a href="#/profile">
							...
							<md-list-item href="#/login" target="_self" v-if="!this.$store.getters.isAuth">
								<i class="material-icons">login</i>
								<p>Login</p>
							</md-list-item>
							<md-list-item href="#/signup" target="_self" v-if="!this.$store.getters.isAuth">
						...
						if (change.type === "added") {
							db.collection("users")
								...
								.then((doc) => {
									...
									let msg = doc.firstName + " has requested for your " + data.foodName;
						...
						if (change.type === "modified") {
							db.collection("users")
								...
								.then((doc) => {
									...
									let msg =
										doc.firstName + " has " + data.status + " your request for " + data.foodName;
