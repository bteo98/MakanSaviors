		...
		<md-card-content>
			<div class="md-layout">
				<div class="md-layout-item">
					<i class="material-icons close" v-on:click="confirmDelete" v-if="listingOwnership()"
						>delete_outline</i
					>
					<i class="material-icons close" v-on:click="pushToModifyListing" v-if="listingOwnership()"
						>edit</i
					>
					<div>
						<img
