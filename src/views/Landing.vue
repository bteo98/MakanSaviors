                  ...
                  >
                    ...
                    <slide>
                      <div class="carousel-caption">
                        ...
                        />
                        <h4>
                          MakanSaviors brings people from all walks of life
                    ...
                    <slide>
                      <div class="carousel-caption">
                        ...
                        />
                        <h4>
                          Thanks to MakanSaviors, the unused food items at home
                ...
                <div class="team-player">
                  <md-card class="md-card-plain">
                    ...
                    <md-card-actions class="text-center">
                      ...
                      <md-button
                        href="https://github.com/daryl-tan"
                        class="md-just-icon md-simple"
                      >
                        <i class="fab fa-github"></i>
                      </md-button>
                ...
                <div class="team-player">
                  <md-card class="md-card-plain">
                    ...
                    <md-card-actions class="text-center">
                      ...
                      <md-button
                        href="https://github.com/xxalicia"
                        class="md-just-icon md-simple"
                      >
                        <i class="fab fa-github"></i>
                      </md-button>
                ...
                <div class="team-player">
                  <md-card class="md-card-plain">
                    ...
                    <md-card-actions class="text-center">
                      ...
                      <md-button
                        href="https://github.com/zhiqitan"
                        class="md-just-icon md-simple"
                      >
                        <i class="fab fa-github"></i>
                      </md-button>
