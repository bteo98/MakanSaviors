          ...
          <div class="md-layout">
            ...
            >
              ...
              <h5 class="description">
                ...
                actions can lead to big change. Collectively, we can reduce 
                food waste as a nation and build a more sustainable future.
              </h5>
            </div>
          </div>
            ...
            <div class="md-layout">
              <div class="md-layout-item md-medium-size-33 md-small-size-100">
                <div class="info">
                  ...
                  <p>
                    Simply list your surplus food on the webpage or browse through all available food listings to select your desired items.
                  </p>
                </div>
              </div>
              <div class="md-layout-item md-medium-size-33 md-small-size-100">
                <div class="info">
                  ...
                  <p>
                    Users are verified upon sign up to give you a peace of mind as we work towards a zero-waste world
                  </p>
                </div>
              </div>
              <div class="md-layout-item md-medium-size-33 md-small-size-100">
                <div class="info">
                  ...
                  <p>
                    Donate and save with confidence as your data is securely encrypted under 256-bit Advanced Encryption standard
                  </p>
                </div>
              </div>
            </div>
              ...
              <slide>
                <div class="carousel-caption">
                  ...
                  <h4>
                    ...
                    who come to pick-up<br>my food and the interesting 
                    conversations that takes place on the doorstep <br><br>-Elizabeth
                  </h4>
                </div>
              ...
              <slide>
                <div class="carousel-caption">
                  <img backgroud-image: src="https://expertphotography.com/wp-content/uploads/2020/08/social-media-profile-photos-9.jpg" 
                    alt="User2" style="border-radius: 50%; height: 150px; width: 150px; padding: 5px;"/>
                  <h4>
                    MakanSaviour brings people from all walks of life together, 
                    to achieve a<br>common goal - to reduce food waste and build food 
              ...
              <slide>
                <div class="carousel-caption">
                  ...
                  <h4>
                    ...
                    end<br>up in the trash and are now with someone who needs them more
                    <br><br>-Steven
                  </h4>
                </div>
                <img :src="carousel" alt="carousel" class="carousel-background"/>
