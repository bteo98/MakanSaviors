						...
						<div class="md-layout-item md-size-80 md-xsmall-size-100 mx-auto">
							...
							<div class="md-layout-item md-medium-size-33 md-small-size-100 mx-auto">
								<div class="info text-center" style="padding: 0px 0 30px">
									<h4 class="info-title" style="font-size: 20px; text-align: center">
							...
							<form class="contact-form">
								<div class="md-layout">
									<div class="md-layout-item md-size-50">
										<md-field>
											...
											<md-input v-model="listingName" type="text" required></md-input>
										</md-field>
									</div>
									...
									<div class="md-layout-item md-size-50">
										<md-field>
											...
											<md-input v-model="quantity" type="text" required></md-input>
										</md-field>
									</div>
									<div class="md-layout-item md-size-50">
										<md-field>
									...
									<div class="md-layout-item md-size-50">
										<md-field>
											...
											<md-select class="dropdown" v-model="collectionLocation" multiple required>
									...
									<div class="md-layout-item md-size-50">
										<md-field>
											...
											<md-select v-model="dietaryRestrictions" multiple>
												...
												<md-option value="Contains Dairy">Contains Dairy</md-option>
												<md-option value="Contains Peanuts">Contains Peanuts</md-option>
												<md-option value="Contains Shellfish">Contains Shellfish</md-option>
								...
								<md-field maxlength="5">
									<label>Remarks</label>
									<md-textarea v-model="remarks" md-autogrow required></md-textarea>
								</md-field>

								<div class="md-layout">
									<div class="md-layout-item md-size-33 mx-auto text-center">
										<md-button class="md-success" v-on:click="checkRequiredFields"
...
export default {
	...
	methods: {
		...
		getListingPic: function() {
			var storageRef = firebase.storage().ref(this.UID + "/donationImages/" + this.listingID);
